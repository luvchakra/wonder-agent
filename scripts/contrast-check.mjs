...
const light = {
  background: [0.965, 0.004, 250],
  foreground: [0.16, 0.015, 257],
  card: [1, 0, 0],
  cardForeground: [0.16, 0.015, 257],
  primary: [0.55, 0.21, 262],
  primaryForeground: [0.99, 0, 0],
  secondary: [0.955, 0.004, 250],
  secondaryForeground: [0.16, 0.015, 257],
  muted: [0.955, 0.004, 250],
  mutedForeground: [0.53, 0.018, 257],
  accent: [0.94, 0.02, 262],
  accentForeground: [0.34, 0.11, 262],
  destructive: [0.55, 0.21, 25],
  destructiveForeground: [0.99, 0, 0],
  success: [0.5, 0.14, 155],
  warning: [0.52, 0.15, 75],
  info: [0.52, 0.14, 245],
  border: [0.9, 0.006, 250],
  input: [0.62, 0.01, 250],
};

const dark = {
  background: [0.16, 0.015, 257],
  foreground: [0.95, 0.005, 250],
  card: [0.205, 0.016, 257],
  cardForeground: [0.95, 0.005, 250],
  primary: [0.72, 0.17, 262],
  primaryForeground: [0.16, 0.015, 257],
  secondary: [0.25, 0.016, 257],
  secondaryForeground: [0.95, 0.005, 250],
  muted: [0.25, 0.016, 257],
  mutedForeground: [0.68, 0.016, 250],
  accent: [0.28, 0.05, 262],
  accentForeground: [0.85, 0.07, 262],
  destructive: [0.68, 0.19, 25],
  destructiveForeground: [0.16, 0.015, 257],
  success: [0.72, 0.15, 155],
  warning: [0.76, 0.14, 75],
  info: [0.72, 0.13, 245],
  border: [0.29, 0.016, 257],
  input: [0.5, 0.025, 257],
};
